...
const SearchBar = (props: SearchBarProps) => {
  ...
  return (
    <div
      className={`hidden w-screen h-screen bg-primary-200 min-w-87.5 py-8 px-10 shadow-[5px_0px_10px_rgba(0,0,0,0.2)] z-20 absolute top-0 left-0 translate-x-[-100%] transition-all duration-500 lg:relative lg:left-0 lg:w-1/5 lg:translate-x-0 lg:block ${searchDisplay ? "translate-x-0" : ""}`}
    >
      <Logo type="web" />
      <div className="w-11/12 relative mt-6 mb-3 text-right mx-auto sm:w-full">
        <button className="absolute top-2.5 left-0 rotate-180" onClick={props.toggle}>
        ...
        <input
          ...
          ref={ref}
        />
        <button className="absolute top-2.5 right-5" onClick={handleSearch}>
