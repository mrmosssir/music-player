...
const AuthGroup = (props: AuthGroupProps) => {
    ...
    const loginBtn = () => {
        return (
            <button className="flex items-center bg-transparent border border-white-500 px-6" onClick={() => login()}>
                登入
            </button>
        );
    };
    ...
    const profileBtn = () => {
        return (
            <button className="flex items-center bg-transparent border border-white-500 px-1 relative" onClick={() => setToggle(!toggle)}>
    ...
    return (
        <div className="flex justify-center items-center relative lg:justify-between">
            ...
            <div className="hidden items-center lg:flex">
                <button className="text-white h-10 rounded-full tracking-wider">Music Premium</button>
