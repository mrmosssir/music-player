...
const Banner = (props: BannerProps) => {
  ...
  return (
    <div className="relative rounded-lg h-80 mt-6 overflow-hidden">
      <div
        className="w-full h-full bg-cover bg-center bg-no-repeat blur-lg absolute top-0 left-0 z-0 before:block before:w-full before:h-full before:bg-black/50 before:blur-lg before:absolute before:top-0 before:left-0"
        style={innerStyle}
      ></div>
      <img className="block h-full absolute top-0 left-1/2 translate-x-[-50%]" src={props.image} alt="" />
      <div className="absolute bottom-0 w-full h-24 px-10 flex justify-between items-center bg-linear-to-b from-transparent to-black-500">
        <div>
